...
////// Emissive:
                ...
                float3 node_8878 = (lerp(float3(0,0,0),float3(0,1,1),pow((distance(i.posWorld.rgb,node_4780)/_Anis),_Falloff))+(1.0 - _GridAlpha_var.rgb));
